  ...
  public void createReportSummary() {
    ...
    try {
      ...
      Object greek_customers =
          scriptExecutor.executeQScriptWithReturn("select from greek_customers", kdbHost, kdbPort);
      results.add(greek_customers);
      Object uk_customers =
          scriptExecutor.executeQScriptWithReturn("select from uk_customers", kdbHost, kdbPort);
